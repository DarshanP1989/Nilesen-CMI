// NPM Check: HairColor_Statewise
const path = require('path');
const { loadSheet, extractMarketProduct } = require(path.join(__dirname, '_shared_npm'));

const CATEGORY    = 'HairColor_Statewise';
const SHEET_IDX   = 0;
const HEADER_COLS = ['Markets', 'Facts', 'Products'];
const MARKET_COL  = 0;
const PRODUCT_COL = 2;  // null = markets only

module.exports = function checkNPM_HairColor_Statewise(filePaths, masterLookup) {
  const errors = [];
