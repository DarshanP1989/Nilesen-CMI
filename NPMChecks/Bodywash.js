...
const CATEGORY    = 'Bodywash';
const SHEET_IDX   = 0;
const HEADER_COLS = ['Markets', 'Facts', 'BODY WASH', 'MANUFACTURER', 'BRAND', 'Products'];
const MARKET_COL  = 0;
const PRODUCT_COL = 5;  // null = markets only

module.exports = function checkNPM_Bodywash(filePaths, masterLookup) {
  const errors = [];
