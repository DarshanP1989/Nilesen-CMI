// DQ: Soaps_Cumulative — converted from Soaps_Cumulative.py
// Checks: count=1, sheet index 0 starts '1-',
...
module.exports = function validateSoaps_Cumulative(filePath, allFiles) {
  const errors = [];
  try {
